...
public class TextViewColor extends android.support.v7.widget.AppCompatTextView {
    private int width;
    /** 移动距离*/
    ...
    public TextViewColor(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        linearGradient=new LinearGradient(-width, 0,0,0,
                new int[]{Color.BLACK, Color.GRAY, Color.WHITE
        },
                new float[]{0,0.5f,1f},
